...
import type { Aircraft, TimelineMedia } from "@/lib/data/aircraft/types";
...
function TimelineImage({ media }: { media: TimelineMedia }) {
  ...
  return (
    <div
      ref={ref}
      className="relative mt-5 max-w-[640px] border border-line rounded-[14px] overflow-hidden aspect-[16/10] bg-panel2 shadow-[0_24px_60px_rgba(0,0,0,0.45)]"
    >
      ...
      <div className="relative z-[1] mx-auto max-w-[1180px] px-6">
        ...
        <div className="relative pl-[34px]">
          ...
          {aircraft.timeline.map((t, i) => (
            <Reveal key={i}>
              <div className="relative pb-[44px] last:pb-0 pl-1.5">
