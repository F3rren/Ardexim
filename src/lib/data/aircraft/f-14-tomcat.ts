...
export const f14Tomcat: Aircraft = {
  ...
  timeline: [
    ...
    { year: "1986", tag: { label: "Cultura pop" }, title: "Top Gun", text: "Il film con Tom Cruise trasforma il Tomcat in un'icona globale e fa impennare gli arruolamenti in Marina. Per una generazione, «caccia» significa F-14." },
